...
console.log("DEBUG: set a timeout for starting listeners in 20 secs, checking listeners 40 secs");
setTimeout(startListeners, 20000);
setTimeout(function () { return console.log("DEBUG", GameDoc, GameUsers); }, 40000);
